...
# Methode SBS
# Permet de selectionner les k features les plus intéressantes
# A chaque fois on retire de notre modèle la feature qui retiré minimise beaucoup le cout global
class SBS():
